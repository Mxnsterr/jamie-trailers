...
RegisterNetEvent('jamie-menu:client:openMenu', function(data)
    openMenu(data)
end)

RegisterNetEvent('jamie-menu:client:closeMenu', function()
    closeMenu()
end)
...
RegisterNUICallback('closeMenu', function(_, cb)
    ...
    SetNuiFocus(false)
    cb('ok')
    TriggerEvent("jamie-menu:client:menuClosed")
end)
